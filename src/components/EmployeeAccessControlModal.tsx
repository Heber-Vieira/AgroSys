...
const AVAILABLE_MODULES: ModuleOption[] = [
  { id: 'dashboard', name: 'Painel Geral Executivo (BI)', category: 'Gestão & Sistema', description: 'Indicadores globais, DRE e hectares aplicados' },
  { id: 'spray-workflow', name: 'Esteira do Processo (10 Passos)', category: 'Operacional', description: 'Passo a passo operacional de pulverização ponta a ponta' },
  { id: 'orders', name: 'Ordens de Serviço (OS)', category: 'Operacional', description: 'Criação, triagem, planejamento e despacho de missões' },
  { id: 'schedule', name: 'Agenda & Escala Operacional', category: 'Operacional', description: 'Calendário de agendamento de equipes e cronograma de voos' },
  { id: 'gis', name: 'Talhões & Mapas GIS (NDVI)', category: 'Agronomia & Clima', description: 'Mapeamento satelital, limites e áreas úteis de lavouras' },
  { id: 'telemetry', name: 'Telemetria de Voo ao Vivo', category: 'Operacional', description: 'Altitude, vazão, faixas aplicadas e RTK em tempo real' },
  { id: 'spray-mix', name: 'Cálculo de Calda (WALES) & NR-31', category: 'Agronomia & Clima', description: 'Dosagem, ordem de mistura WALES, tanque e EPIs' },
  { id: 'weather', name: 'Centro Meteorológico & Delta T', category: 'Agronomia & Clima', description: 'Vento, temperatura, umidade e laudo climático de deriva' },
  { id: 'reports', name: 'Relatórios Técnicos (MAPA)', category: 'Gestão & Sistema', description: 'Emissão de laudos oficiais de aplicação IN MAPA 19/298' },
  { id: 'pricing', name: 'Matriz de Precificação por Ha', category: 'Comercial & Frota', description: 'Tabela de preços por hectare, cultura e relevo' },
  { id: 'quotations', name: 'Orçamentos Comerciais', category: 'Comercial & Frota', description: 'Cotação por hectare e propostas para produtores' },
  { id: 'financial', name: 'Financeiro, Comissões & DRE', category: 'Gestão & Sistema', description: 'Extratos de repasse, faturamento, comissões e custos' },
  { id: 'fleet', name: 'Frota de Drones & Baterias', category: 'Comercial & Frota', description: 'Aeronaves, ciclos de carga de baterias e manutenção' },
  { id: 'admin-management', name: 'Hub de Gestão & Cadastros', category: 'Gestão & Sistema', description: 'Gestão de usuários, empresas, cadastros e acessos' },
  { id: 'branding', name: 'Studio de Marca & White Label', category: 'Gestão & Sistema', description: 'Customização de logotipo, cores da empresa e marca' },
  ...
  { id: 'docs', name: 'Documentação Técnica & APIs', category: 'Agronomia & Clima', description: 'Biblioteca de bulas químicas, manuais e endpoints REST' },
];
